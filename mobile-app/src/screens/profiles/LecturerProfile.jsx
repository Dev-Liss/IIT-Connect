        ...
        try {
            ...
            if (json.success && json.comment) {
                setComments((prev) => [...prev, {
                    ...json.comment,
                    user: { username: profileData?.username || user?.username, profilePicture: profileData?.profilePicture },
                }]);
                setCommentText("");
            }
        } catch (e) {
        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
                <View style={styles.coverContainer}>
                    <Image source={{ uri: profileData?.coverPicture || DEFAULT_COVER }} style={styles.coverImage} />
                </View>

                <View style={styles.profileHeader}>
                    <View style={styles.avatarContainer}>
                        <Image source={{ uri: profileData?.profilePicture || DEFAULT_AVATAR }} style={styles.avatar} />
                    </View>
                    <View style={styles.actionRow}>
                        ...
                        {userPosts.length > 0 ? (
                            userPosts.map((post) => (
                                <View key={post._id} style={styles.postCard}>
                                    ...
                                    {post.media?.url ? (
                                        <Image source={{ uri: post.media.url }} style={styles.postImage} resizeMode="cover" />
                                    ) : null}
                            ...
                            <FlatList
                                ...
                                renderItem={({ item }) => (
                                    <View style={styles.commentRow}>
                                        <Image source={{ uri: item.user?.profilePicture || DEFAULT_AVATAR }} style={styles.commentAvatar} />
...
const styles = StyleSheet.create({
    ...
    card: { backgroundColor: "#fff", borderRadius: 16, padding: 20, marginBottom: 20, elevation: 2, borderWidth: 1, borderColor: '#eee' },
    ...
    postCard: { backgroundColor: "#fff", borderRadius: 12, padding: 15, marginBottom: 15, elevation: 2, borderWidth: 1, borderColor: "#f0f0f0" },
    ...
    commentsSheet: { backgroundColor: "#fff", borderTopLeftRadius: 20, borderTopRightRadius: 20, maxHeight: height * 0.75, minHeight: height * 0.45 },
    commentsHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingHorizontal: 20, paddingVertical: 16, borderBottomWidth: 1, borderBottomColor: "#f0f0f0" },
    ...
    commentInputRow: { flexDirection: "row", alignItems: "center", paddingHorizontal: 16, paddingVertical: 12, borderTopWidth: 1, borderTopColor: "#f0f0f0", backgroundColor: "#fff", gap: 10 },
    commentInput: { flex: 1, backgroundColor: "#f5f5f5", borderRadius: 20, paddingHorizontal: 15, paddingVertical: 10, fontSize: 14, color: "#000", maxHeight: 80 },
    sendButton: { width: 38, height: 38, borderRadius: 19, backgroundColor: "#D32F2F", alignItems: "center", justifyContent: "center" },
});