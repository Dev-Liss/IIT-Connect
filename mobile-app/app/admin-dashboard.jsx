...
import ContentReportCard from "../src/components/ContentReportCard";
import { REPORT_ENDPOINTS, CONTENT_REPORT_ENDPOINTS } from "../src/config/api";
...
export default function AdminDashboardScreen() {
    ...
    // Fetch reports when filter status or tab changes
    useEffect(() => {
        fetchReports();
    }, [filterStatus, activeTab, fetchReports]);
    ...
    const renderFilters = () => (
        ...
        >
            {(["all", "pending", "ongoing", "solved", "rejected"]).map((status) => (
                <TouchableOpacity
                    key={status}
                    style={[
                        styles.filterButton,
